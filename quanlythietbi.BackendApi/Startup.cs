...
namespace quanlythietbi.BackendApi
{
    public class Startup
    {
        ...
        {
            services.AddDbContext<QuanLyThietBiDbContext>(options =>
           options.UseSqlServer(Configuration.GetConnectionString(SystemConstains.MainConnectionString)));
        ...
        public void Configure(IApplicationBuilder app, IWebHostEnvironment env)
        {
            ...
            app.UseSwaggerUI(c =>
           {
               c.SwaggerEndpoint("/swagger/v1/swagger.json", "swagger Movive Demo v1");
           });
